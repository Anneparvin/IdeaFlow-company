...
const Connection = () => {
    ...
    return (
        <div className='flex lg:flex-row flex-col lg:max-w-4xl w-full mx-auto text-white mt-16 space-y-8'>
            <div className='w-full space-x-12'> 
                <img className="batting-animation lg:p-2 p-6" src='https://i.ibb.co/rpFvbVp/Tendulkar-batting-against-Australia-October-2010-1-cropped-removebg-preview.png' alt='pic'/>
                
               
            </div>
            
        
            <div className='lg:w-60 w-30 lg:p-2 p-6 align-bottom brightness-100'>
