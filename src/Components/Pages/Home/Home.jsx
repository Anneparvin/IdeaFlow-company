...
const Home = () => {
    return (
      <div className='flex justify-between text-white lg:max-w-5xl mx-auto mt-24 animate-pulse p-8'>
         ...
         <div className='flex justify-around w-30 mt-16 static items-center'>
           <button className='button px-6 py-3 bg-teal-400 font-bold rounded-xl transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-110 hover:bg-green-500 duration-700 animate-button' href="https://ideaflow.app/" target="_blank">Try Adidas Notes</button> 
